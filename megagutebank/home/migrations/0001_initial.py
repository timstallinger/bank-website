    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('approved_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='home.employee')),
        ...
        migrations.AddField(
            model_name='account',
            name='employee',
            field=models.ForeignKey(blank=True, default=None, on_delete=django.db.models.deletion.DO_NOTHING, to='home.employee'),
        ),
        migrations.AddField(
            model_name='account',
            name='owner',
