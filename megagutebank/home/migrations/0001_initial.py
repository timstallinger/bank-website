    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('approved_by', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='home.employee')),
                ('sending_account', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='sending_account', to='home.account')),
            ],
        ),
        migrations.CreateModel(
            name='Tan',
